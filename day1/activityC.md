...
The lastest version, called [ASTER](https://github.com/chaoszhang/ASTER/), uses a different algorithmic approach that may be more robust to missing data the the previous one.
